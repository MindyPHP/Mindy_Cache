...
class MemCache extends Cache
{
    ...
    public function init()
    {
        ...
        if (empty($servers)) {
            ...
            foreach ($servers as $server) {
                if ($server->host === null) {
                    throw new InvalidArgumentException("The 'host' property must be specified for every memcache server.");
                }
                if ($this->useMemcached) {
     ...
     * @throws InvalidArgumentException if memcache or memcached extension is not loaded
     */
    public function getMemcache()
    {
        if ($this->_cache === null) {
            ...
            if (!extension_loaded($extension)) {
                throw new InvalidArgumentException("MemCache requires PHP $extension extension to be loaded.");
            }
